  ...
  <form @submit.prevent="submitForm" class="space-y-2 p-1 sm:p-2">
    ...
    <div>
      ...
      <InputText
        ...
        class="w-full"
      />
      <small v-if="errors.email" class="text-red-500 block mt-1"
    ...
    <div>
      ...
      <Rating
        ...
        class="text-sm"
      />
      <small v-if="errors.rating" class="text-red-500 block mt-1"
        >Please give a rating (1–5).</small
      >
    </div>
    ...
    <div>
      ...
      <DatePicker
        ...
        inputClass="w-full"
      />
      <small v-if="errors.date" class="text-red-500 block mt-1"
    ...
    <div>
      ...
      <Select
        ...
        inputClass="w-full"
      />
      <small v-if="errors.status" class="text-red-500 block mt-1"
